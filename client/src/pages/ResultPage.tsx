  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-8">
      <div className="max-w-7xl mx-auto flex gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="mt-6 flex justify-end">
                  <button
                    className="group flex items-center space-x-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-6 py-3 rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all cursor-pointer"
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-center space-x-4 p-4 bg-amber-50 rounded-xl border border-amber-200">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-gray-800">{result?.isPartialEvaluation ? "Yes" : "No" }</p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="flex justify-end pt-4">
                  <button
                    className="group flex items-center space-x-2 bg-gradient-to-r from-purple-500 to-pink-600 text-white px-8 py-3 rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all cursor-pointer"
        ...
        <div className="w-80 flex-shrink-0 sticky top-8 h-fit"> <Sidebar sessionId={sessionId!} /> </div>
      </div>
